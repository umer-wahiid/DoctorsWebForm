...
namespace DoctorsWebFourm.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Fullname,ContactNumber,Address,Country,Specialization,Qualification,Experience,Achievements,Password,CPassword,Email,RegistrationDate,IsAdmin,IsPrivateProfile,Img")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
